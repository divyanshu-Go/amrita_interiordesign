...
//
// ── WHAT CHANGED & WHY ────────────────────────────────────────────────────
// "use client" is REQUIRED here — correct. This component uses:
//   • useState (filteredProducts, showFilters)
//   • useAuth() for userRole (needed for role-based price filtering)
//   • Event handlers (handleFilterChange, button clicks)
//
// ONE CHANGE: Removed `userRole` prop passed to <ProductCardGrid>.
//   ProductCardGrid now calls useAuth() internally — no prop needed.
//   Passing it as a prop was redundant after our ProductCardGrid fix.
// ─────────────────────────────────────────────────────────────────────────
    ...
    <div className="grid grid-cols-1 sm:grid-cols-12 gap-6">
      ...
      <main className="sm:col-span-8 md:col-span-9 col-span-12">
        ...
        <p className="text-sm text-gray-600 mb-4">
          ...
          {" "}of{" "}
          <span className="font-semibold text-gray-700">{products.length}</span> results
        </p>
