...
export async function getAllApplications() {
  if (process.env.NODE_ENV === "production") {
    ...
    console.log("VERCEL_URL (System Env):", process.env.VERCEL_URL);
    // NEXT_PUBLIC_VERCEL_URL is not available in non-public context unless you set it
    console.log("NEXT_PUBLIC_VERCEL_URL (Custom Env):", process.env.NEXT_PUBLIC_VERCEL_URL);
    console.log("BASE_URL being used:", BASE_URL);
    console.log("Full Fetch URL:", `${BASE_URL}/api/applications`);
    console.log("----------------------");
  }
  try {
